...
In addition to the official user guide, this [document](https://ihds.umd.edu/sites/default/files/publications/papers/technical%20paper%201.pdf) seems to have a lot more information on the sampling strategy.  In particular, it talks a lot more about things like the facility sampling strategy.
