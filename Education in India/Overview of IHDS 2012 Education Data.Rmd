...
Check response rates and then use weights to calculate average ASER score by state
```{r}
...
# obtain weighted mean ASER scores by state
# first print out value labels for STATEID. (Can't figure out how to modify output so that it uses labels)
