...
Calculate percentage of students with ASER == 4 (i.e. can read std 2 level text) for rural govt school or private aided (CS4 == 3 | CS4 ==4) students in grades 2 to 4 (there are too few students if we restrict only to grade 3) by state. *warning: this code takes a long time* 
...
Merge IHDS with ASER and NAS, calculate correlations 
